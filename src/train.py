...
def load_data(path):
    ...
    logging.info("[INFO] loading done")
...
def train(aug, trainX, trainY, testX, testY, args):
    ...
    #model = ResNet101.build(img_rows=norm_size, img_cols=norm_size, color_type=3, num_classes=CLASS_NUM)
    model = GoogleNet.build(img_rows=norm_size, img_cols=norm_size, color_type=3, num_classes=CLASS_NUM)
